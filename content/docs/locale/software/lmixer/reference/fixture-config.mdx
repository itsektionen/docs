...
This config file is also responsible for generating [Fixture types in Kistan](kistan_fixture_types) and
[Fixtures in Kistan's LMixer](kistan_lmixer_fixtures)
