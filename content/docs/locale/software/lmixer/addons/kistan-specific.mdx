...
These have the [Addon Suite](./addon-suite/) as a
required dependency.
...
| name     | description                                           |
| -------- | ----------------------------------------------------- |
| shader   | See [shaders](./addon-suite/effects#shader)           |
...
| color         | [RGBColor](./addon-suite/util#rgbcolor) | The color of the spiral, defaults to 0x010101 |
...
<CalloutExt type="info">
  The sign's coordinates are very spaced out. While on the roof it is
  1unit/pixel, on the sign it is significantly larger.
</CalloutExt>
### `sign_heartbeat`
...
| color        | [RGBColor](./addon-suite/util#rgbcolor) | The color of the pulse                               |
| backColor    | [RGBColor](./addon-suite/util#rgbcolor) | The color of the background, defaults to 0x000000    |
...
**_Example:_** Make the A pulse white
...
| colors     | [RGBColor](./addon-suite/util#rgbcolor) | Array of colors for each block.                   |
