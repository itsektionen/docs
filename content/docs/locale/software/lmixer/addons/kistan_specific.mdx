...
| name     | description                                           |
| -------- | ----------------------------------------------------- |
| shader   | See [shaders](./addon_suite/effects#shader)           |
...
| color         | [RGBColor](./addon_suite/util#rgbcolor) | The color of the spiral, defaults to 0x010101 |
...
| color        | [RGBColor](./addon_suite/util#rgbcolor) | The color of the pulse                               |
| backColor    | [RGBColor](./addon_suite/util#rgbcolor) | The color of the background, defaults to 0x000000    |
...
| colors     | [RGBColor](./addon_suite/util#rgbcolor) | Array of colors for each block.                   |
