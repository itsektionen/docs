...
A extended version of [`fix`](./../../scripting#fix).
...
<CalloutExt type="info">
  size and default value are not applicable since theses are set by
  alpha_data_layer
</CalloutExt>
...
For [set](./../../scripting#set) and [dim](./../../scripting#dim), the new data is
calculated, but does not take effect until the alpha is set to a non-zero value.

For [execute](./../../scripting#execute), [run](./../../scripting#run), [start](./../../scripting#start),
[play](./../../scripting#play), and [stop_play](./../../scripting#stop_play), since
...
<CalloutExt type="tip">
  In this case, direct alpha access makes sense, however, in general taking
  control of the entire fixture is desired, for this
  [take_control_of_fixture](#take-control-of-fixture) and
...
[Alpha-data layer scripting](mixing#alpha-data-layer-scripting) for an
