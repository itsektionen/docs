...
![A fade between blue and red](./images/fade_normal.png)
...
![A fade between blue and red with intensity going down](./images/fade_dim.png)
...
![A fade between blue and red with another layer creating on/off pattern](./images/fade_on_off.png)
...
**_Example:_** take control of the washes, lamps, the microwaves, and box lights.
...
**_Example:_** Multi-script layer control:
