...
The [DALI protocol](https://en.wikipedia.org/wiki/Digital_Addressable_Lighting_Interface)
is used for all normal roof lights in Kistan. It is also used in all classrooms.
...
cmd-tool [`dalicmd`](https://github.com/Daedaluz/dalicmd) on the IN-2 server
