...
Since most games use higher-numbered ports, ports `3000-50000` are port-forwarded to IN-ITK.
In addition, port `2222` is port-forwarded to port `22` to allow for SSH into IN-ITK.
