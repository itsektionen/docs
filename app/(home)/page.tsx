...
const backgroundBehindItems = "dark:bg-fd-background/90 not-dark:bg-fd-background/75"
...
export default function HomePage() {
  return (
    <div className="flex-1 flex flex-col justify-center items-center">
      ...
      <DocksBackground></DocksBackground>
    </div>
  );
}

function DocsTitle() {
  return <div className={cn("w-full max-w-90 mx-auto rounded-2xl p-2 mb-2", backgroundBehindItems)}>
    <h1 className="text-5xl mb-2 font-bold">&lt;it/docs&gt;</h1>
    <p className="text-sm prose mb-3 mx-4">Documentation for the IT Chapter</p>
    <StartReadingButton></StartReadingButton>
  </div>
}
...
function PageShortcuts() {
  ...
  return <div className={cn("rounded-2xl p-2", backgroundBehindItems)}>
...
function HeaderDivider({ children }: { children: ReactNode }) {
  return <div className="grid grid-cols-[1fr_auto_1fr] gap-5 items-center mb-4">
    <div className="h-0.5 bg-fd-accent"></div>
...
function DocksBackground() {
  return <div className="fixed inset-0 mb-[1%] overflow-hidden flex flex-col-reverse items-center select-none pointer-events-none dark:opacity-50">
    <Image className="block w-full min-w-200" src={DocksImage.src} width={DocksImage.width} height={DocksImage.height} alt="docks"></Image>
  </div>
}